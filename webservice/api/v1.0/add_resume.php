...
require $_SERVER['DOCUMENT_ROOT'].'/dev_cvmaker/include/PHPMailer/PHPMailerAutoload.php';
/* include autoloader */
require_once $_SERVER['DOCUMENT_ROOT'].'/dev_cvmaker/include/dompdf/autoload.inc.php';
...
if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if (empty($result)){
                 ...
                 $tech_skill2 = isset($_POST['tech_skill2']) ? mysql_real_escape_string($_POST['tech_skill2']) : "";
                 $tech_skill3 = isset($_POST['tech_skill3']) ? mysql_real_escape_string($_POST['tech_skill3']) : "";
                 ...
                 $achievements2 = isset($_POST['achievements2']) ? mysql_real_escape_string($_POST['achievements2']) : "";
                 
            	 $aoi = isset($_POST['aoi']) ? mysql_real_escape_string($_POST['aoi']) : "";
                 $aoi2 = isset($_POST['aoi2']) ? mysql_real_escape_string($_POST['aoi2']) : "";
                 $aoi3 = isset($_POST['aoi3']) ? mysql_real_escape_string($_POST['aoi3']) : "";
                 
            	 $language = isset($_POST['language']) ? mysql_real_escape_string($_POST['language']) : "";
                 $language2 = isset($_POST['language2']) ? mysql_real_escape_string($_POST['language2']) : "";
                 $language3 = isset($_POST['language3']) ? mysql_real_escape_string($_POST['language3']) : "";
                 ...
                 $format = isset($_POST['format']) ? mysql_real_escape_string($_POST['format']) : "";
                    ...
                    if(isset($_FILES['photo']['name'])){
                        ...
                        $photoname = $_POST['name'].'-'.basename($_FILES["photo"]["name"]);
             ...
             $sql = "INSERT INTO `cv_manager`.`resumes` (`name`, `father_name`, `mobile`, `email`, `address`, `city`, `district`, `pincode`, 
              ...
              `tech_skill2`, `tech_skill3`, `project_title`, `project_disc`, `inplant_train`, `conference_title`, `conference_disc`, `achievements`, 
              `achievements2`, `aoi`, `aoi2`, `aoi3`, `language`, `language2`, `language3`, `dob`, `gender`, `material_status`, `nationality`, `photo`,
              `declaration`, `sign`)
             VALUES ('$name', '$father_name', '$mobile', '$email', '$address', '$city', '$district', '$pincode', '$carrer_objective', '$deg_course',
              ...
              '$hsc_parcentage', '$sslc_course', '$sslc_institution', '$sslc_place', '$sslc_yop', '$sslc_parcentage', '$tech_skill', '$tech_skill2',
              '$tech_skill3', '$project_title', '$project_disc', '$inplant_train', '$conference_title', '$conference_disc', '$achievements', 
              '$achievements2', '$aoi', '$aoi2', '$aoi3', '$language', '$language2', '$language3', '$dob', '$gender', '$material_status', '$nationality',
              '$photoname', '$declaration', '$sign');";
        	 ...
        	 if($save)
             {
                    ...
                    $html = '<!DOCTYPE html>
                            ...
                            <div class="container">
                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <p>
                                        '.$_POST['tech_skill'].'</br>'.$_POST['tech_skill2'].'</br>'.$_POST['tech_skill3'].'
                                        </p>
                                        <!--<p><strong>Frameworks/Tools:</strong> Punch Cards</p> -->
                                    </div>
                                </div>
                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <p>
                                          '.$_POST['achievements'].'</br>'.$_POST['achievements2'].'
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <p>
                                          '.$_POST['aoi'].'</br>'.$_POST['aoi2'].'</br>'.$_POST['aoi3'].'
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <p>
                                          '.$_POST['language'].'</br>'.$_POST['language2'].'</br>'.$_POST['language3'].'
                                        </p>
                                    </div>
                                </div>
                ...
                $dompdf->render();
                 ...
                 $pdf_file_location =  $_SERVER['DOCUMENT_ROOT']."/dev_cvmaker/document/pdf/$pdf_name";
                ...
                /************** geting file content Ror Word file generate ***********/
                    ...
                    //store in local file
                     ...
                     $word_file_location = $_SERVER['DOCUMENT_ROOT']."/dev_cvmaker/document/word/$word_name";
                ...
                /* Send email to user with the generated PDF file  */
                   ...
                   // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
                    ...
                    /* Update generated file name on database table */
                    $sql = "UPDATE `cv_manager`.`resumes` SET `word_file` = '$word_name', `pdf_file` = '$pdf_name', `format` = '$format' WHERE id='$last_id'";
